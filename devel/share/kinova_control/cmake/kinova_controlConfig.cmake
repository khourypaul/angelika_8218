...
if("TRUE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /home/razer/catkin_ws_assistive/src/kinova-ros/kinova_control)
  set(kinova_control_DEVEL_PREFIX /home/razer/catkin_ws_assistive/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /home/razer/catkin_ws_assistive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/razer/catkin_ws_assistive/src/kinova-ros/kinova_control/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(kinova_control_EXPORTED_TARGETS ${${kinova_control_dep}_EXPORTED_TARGETS})
endforeach()
