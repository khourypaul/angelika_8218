...
(cl:in-package uwb_gazebo_plugin-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Ranging>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ranging)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uwb_gazebo_plugin-msg:<Ranging> is deprecated: use uwb_gazebo_plugin-msg:Ranging instead.")))

(cl:ensure-generic-function 'anchorId-val :lambda-list '(m))
(cl:defmethod anchorId-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:anchorId-val is deprecated.  Use uwb_gazebo_plugin-msg:anchorId instead.")
  (anchorId m))

(cl:ensure-generic-function 'tagId-val :lambda-list '(m))
(cl:defmethod tagId-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:tagId-val is deprecated.  Use uwb_gazebo_plugin-msg:tagId instead.")
  (tagId m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:range-val is deprecated.  Use uwb_gazebo_plugin-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:seq-val is deprecated.  Use uwb_gazebo_plugin-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'rss-val :lambda-list '(m))
(cl:defmethod rss-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:rss-val is deprecated.  Use uwb_gazebo_plugin-msg:rss instead.")
  (rss m))

(cl:ensure-generic-function 'errorEstimation-val :lambda-list '(m))
(cl:defmethod errorEstimation-val ((m <Ranging>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uwb_gazebo_plugin-msg:errorEstimation-val is deprecated.  Use uwb_gazebo_plugin-msg:errorEstimation instead.")
  (errorEstimation m))
